...
const StepIndicator: React.FC = () => {
    ...
    return (
        <div className="no-print">
            {/* Desktop */}
            <div className="hidden md:flex items-center justify-center gap-2 py-2 bg-white shadow-sm">
                {steps.map((step, i) => {
                    return (
            ...
            {/* Mobile compact */}
            <div className="md:hidden flex items-center justify-center gap-1 py-2 bg-white shadow-sm px-2">
                {steps.map((step, i) => {
                    return (
                        <React.Fragment key={step.num}>
